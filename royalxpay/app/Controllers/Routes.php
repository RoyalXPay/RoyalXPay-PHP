...
$routes->group('api/aadc-payment', function($routes) {
    $routes->get('/', 'Api\AadcPayment::index');
    $routes->post('token', 'Api\AadcPayment::getToken');
    $routes->post('get-token', 'Api\AadcPayment::getToken');
    $routes->post('process', 'Api\AadcPayment::makePayment');
    $routes->get('balance', 'Api\AadcPayment::walletBalance');
    $routes->post('transaction-report', 'Api\AadcPayment::transactionReport');
        $routes->post('aadc-payment/fetch-bill', 'Api\AadcPayment::fetchBill');

});

$routes->post('api/aadc-payment/fetch-bill', 'Api\AadcPayment::fetchBill');
