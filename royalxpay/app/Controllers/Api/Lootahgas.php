...
use Mpdf\Mpdf;
class Lootahgas extends BaseController
{
    use ResponseTrait;
    ...
    {
        return view('admin/Api/lootahgas/index', [
            'pagetitle' => 'lootahgas Payment'
        ]);
    }
...
public function receipt($id)
{
    ...
    try {
        $html = view('admin/Api/lootahgas/receipt_pdf', [
            'txn' => $transaction,
            'merchant' => $merchant,
            'customer' => $customer
        ]);
   ...
   public function reports()
{
    ...
    return view('admin/Api/lootahgas/report', [
        'transactions' => $transactions,
        'pagetitle' => 'lootahgas Payment Reports'
    ]);
}
