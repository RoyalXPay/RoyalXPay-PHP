...
use Mpdf\Mpdf;
class Etisalat extends BaseController
{
    use ResponseTrait;
    ...
    {
        return view('admin/Api/etisalat/index', [
            'pagetitle' => 'Etisalat Payment'
        ]);
    }
...
public function receipt($id)
{
    ...
    try {
        $html = view('admin/Api/etisalat/receipt_pdf', [
            'txn' => $transaction,
            'merchant' => $merchant,
            'customer' => $customer
        ]);
...
$transactionId = date('ymdHis') . substr(microtime(true) * 100, -2) . rand(0, 9) . '3684';
        ...
        try {
            ...
            $providerTransactionId = $balance['responseData']['providerTransactionId'] ?? '';
   ...
   public function reports()
{
    ...
    return view('admin/Api/etisalat/report', [
        'transactions' => $transactions,
        'pagetitle' => 'Etisalat Payment Reports'
    ]);
}
