...
<div class="page-content">
    <div class="container-fluid">
        <h4 class="card-title mb-3">ADDC Utility Payment</h4>
        <div class="row mb-3">
            <div class="col-md-12 d-flex justify-content-end gap-2">
                <a href="<?= site_url('api/addc/reports') ?>" class="btn btn-info">ADDC Payment Reports</a>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#payBtn').click(async function () {
            ...
            try {
                const tokenRes = await fetch("<?= site_url('api/addc/get-token') ?>", { method: 'POST' });
                ...
                const balanceRes = await fetch("<?= site_url('api/addc/fetch-bill') ?>", {
                    method: 'POST',
    ...
    try {
        const payRes = await fetch("<?= site_url('api/addc/make-payment') ?>", {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
        ...
        if (payResult.responseCode === '000') {
            ...
            setTimeout(() => {
                window.location.href = "addc/reports";
            }, 2000);
        } else {
