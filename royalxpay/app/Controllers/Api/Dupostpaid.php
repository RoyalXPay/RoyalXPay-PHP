...
use Mpdf\Mpdf;
class Dupostpaid extends BaseController
{
    use ResponseTrait;
    protected $session;
    ...
    {
        return view('admin/Api/dupostpaid/index', [
            'pagetitle' => 'Du postpaid Payment'
        ]);
    }
...
public function receipt($id)
{
    ...
    try {
        $html = view('admin/Api/dupostpaid/receipt_pdf', [
            'txn' => $transaction,
            'merchant' => $merchant,
            'customer' => $customer
        ]);
    ...
    public function makePayment()
    {
        ...
        try {
            ...
            file_put_contents(WRITEPATH . 'logs/dupostpaid_payment.log', json_encode($result, JSON_PRETTY_PRINT));
   ...
   public function reports()
{
    ...
    return view('admin/Api/dupostpaid/report', [
        'transactions' => $transactions,
        'pagetitle' => 'du postpaid Payment Reports'
    ]);
}
