...
use Mpdf\Mpdf;
class Ajmandirect extends BaseController
{
    use ResponseTrait;
    ...
    {
        return view('admin/Api/ajmandirect/index', [
            'pagetitle' => 'Ajman direct Payment'
        ]);
    }
...
public function receipt($id)
{
    ...
    try {
        $html = view('admin/Api/ajmandirect/receipt_pdf', [
            'txn' => $transaction,
            'merchant' => $merchant,
            'customer' => $customer
        ]);
    ...
    public function makePayment()
    {
      ...
      if (!$token || !$account  || !$apiPaidAmount || !$name || !$transactionId) {
   ...
   public function reports()
{
    ...
    $builder = $model->where('customer_name', $userId)
                     ->where('Payment_type', 'Ajmandirect');
    ...
    return view('admin/Api/ajmandirect/report', [
        'transactions' => $transactions,
        'pagetitle' => 'Ajman direct Payment Reports'
    ]);
}
