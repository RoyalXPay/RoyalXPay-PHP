        ...
        <section class="partner py-5">
            <div class="container py-5">
                <div class="row d-flex align-items-center justify-content-between pb-5">
                    <div class="col-lg-7 col-sm-12 col-md-12" data-aos="fade-left" data-aos-easing="ease-in-out">
                        ...
                        <h1 class="partner-large-head mt-2" style="font-size: 44px;">On the ground floor, we  meet <br> your day-to-day needs. </h1>
                        <p class="partner-text mt-2 mb-2" style="font-size: 17px;">Pay bills. Top-up phones. Recharge DTH. Cover school fees. <br> Pay rent. Everything you need-covered.</p>
                        <ol class="bullet-list ps-3" style="list-style-type: disc!important; list-style: disc!important;">
                            <li class="partner-text" style="font-size: 17px;">Utility bills</li>
                            <li class="partner-text" style="font-size: 17px;">eCommerce transaction</li>
                            <li class="partner-text" style="font-size: 17px;">Card payments & Digital wallet</li> 
                            <li class="partner-text" style="font-size: 17px;">Fee payments</li>
                        </ol>
                    ...
                    <div class="col-lg-5 col-sm-12 col-md-12 d-flex justify-content-end align-items-center" data-aos="fade-right" data-aos-easing="ease-in-out">
                        <img src="assets_frontend/images/Rechargeandbillpayment.png" style="height: auto; width: 100%;" class="banner-img rounded">
                    </div>
                </div>
            </div>
        </section>
