...
function initiateTaskCall(phone) {
    ...
    <!-- banner Area end --> 
        <section class="partner py-5">
            <div class="container">
                <div class="row d-flex align-items-center justify-content-between pb-5">
                    <div class="col-lg-6 col-sm-12 col-md-12" data-aos="fade-left" data-aos-easing="ease-in-out">
                        ...
                        <!-- <h1 class="partner-large-head mt-3" style="font-size: 28px;">The ground floor– Everyday Essentials</h1> -->
                        <h1 class="partner-large-head mt-2">The Investment Oasis: Grow your wealth</h1>
                        <p class="partner-text mt-2 mb-2" style="font-size: 17px;">This is where your money grows. From market to protection,<br> access required financial tools</p>
                        <ol class="bullet-list ps-3" style="list-style-type: disc!important; list-style: disc!important;">
                            <li class="partner-text" style="font-size: 17px;"><strong class="fw-bolder">Wealth Plus – </strong>Build and grow with expert-curated investment tools </li>
                            <li class="partner-text" style="font-size: 17px;"><strong class="fw-bolder">Share Market Mastery – </strong>Trade stocks confidently with guided insights </li>
                            <li class="partner-text" style="font-size: 17px;"><strong class="fw-bolder">Insurance Shield – </strong>Secure what matters most with life & general coverage </li> 
                            <li class="partner-text" style="font-size: 17px;"><strong class="fw-bolder">Fin Advisory – </strong>Personalized financial planning at your fingertips</li>
                        </ol>
                    ...
                    <!-- <div class="col-1"></div> -->
                    <div class="col-lg-6 col-sm-12 col-md-12 d-flex justify-content-end align-items-center" data-aos="fade-right" data-aos-easing="ease-in-out">
                        <img src="assets_frontend/images/wealth1_transparent_hd.png" style="height: auto; width: 100%;" class="banner-img rounded">
                    </div>
                </div>
            </div>
        </section>
