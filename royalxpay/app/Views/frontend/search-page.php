...
/* Full screen hero for search */
.hero {
  min-height: 100vh;   /* full screen height */
  display: flex;
  justify-content: center;
  align-items: center;
  background: #0a1d3a; /* optional, similar to ChatGPT dark bg */
}

.hero .search-box {
  transform: translateY(-100px); /* adjust -50px, -80px, etc. */
}

/* Centered search input styling */
.search-input {
  padding: 15px 20px;
  font-size: 18px;
  border-radius: 30px;
...
/* Results dropdown (reuse but clean) */
#searchResults {
  display: none;
  list-style: none;
  margin: 0;
...
function initiateTaskCall(phone) {
    ...
    <!-- about us area start -->    
     <!-- Hero Section with Centered Search Box -->
<section class="hero d-flex align-items-center justify-content-center">
  <div class="search-box w-75" style="max-width: 700px;    margin-top: -126px;" data-aos="fade-up" data-aos-easing="ease-in-out">
