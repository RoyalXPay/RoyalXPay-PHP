                ...
                <div class="col-lg-6 col-sm-12 col-md-12">
                    ...
                    <div class="d-flex align-items-center mt-4">
                        <a href="http://185.188.127.32/index.php/login" target="_blank" class="btn btn-md btn-warning rounded-pill px-4 py-2 text-light">
                            ...
                            Open an Account</a>
                        <a href="https://royalxpay.com/menu-page"  class="btn btn-md btn-warning rounded-pill px-4 py-2 ms-3 border border-0 text-light" style="background-color: rgba(82, 153, 243, 0.5) !important;">
                            ...
                            <div class="container-body">
                                <div class="container-box mb-0 d-flex justify-content-center align-items-center flex-wrap">
                                    ...
                                    <a href="./menu-page"  class="container-box-menu reacharge-bill bg-light"  style="padding: 12px 0px;">
                                        ...
                                        <a href="#demo"  id="reacharge-bill" class="container-box-menu reacharge-bill  bg-light" data-bs-toggle="collapse" style="padding: 12px 0px;"  rel="noreferrer">
                                            <img src="assets_frontend/images/1725624245350.avif" alt="View All Products" style="width: 100px; height: 100px;border-radius: 49%;">
                                            <!-- <span style="line-height: 16px;">View All Products</span> -->
                                        </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-body">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <div class="pe-5">
                        <h2 class="sc-kOHTFB ezKFuM text-dark mb-0" style="font-size: 22px;">Get started with RoyalXPay</h2>
