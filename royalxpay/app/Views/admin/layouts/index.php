...
<div class="page-content">
    <div class="container-fluid">
        <h4 class="card-title mb-3">nol Topup Payment</h4>
        <div class="row mb-3">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#payBtn').click(async function () {
            ...
            try {
                const tokenRes = await fetch("<?= site_url('api/noltopup/get-token') ?>", { method: 'POST' });
    ...
    try {
        ...
        if (payResult.responseCode === '000') {
            ...
            setTimeout(() => {
                window.location.href = "noltopup/reports";
            }, 2000);
        } else {
