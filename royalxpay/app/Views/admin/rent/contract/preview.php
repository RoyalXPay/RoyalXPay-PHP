                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <p><strong>Discount:</strong> <?= esc($record['discount']); ?>%</p>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <p><strong>Contract Start Date:</strong> <?= esc($record['start_date']); ?></p>
                                </div>
                                <div class="col-md-4">
                                    <p><strong>Contract End Date:</strong> <?= esc($record['end_date']); ?></p>
                                </div>
                                <div class="col-md-4">
