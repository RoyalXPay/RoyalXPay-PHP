                                ...
                                <table id="datatable" class="table table-bordered table-striped dt-responsive w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-sortable="true" class="text-center">Transaction Type</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($results as $items) {
                                            ...
                                            $productType = (isset($items['contract_type']) && $items['contract_type'] == "rent" || isset($items['quotation_type']) && $items['quotation_type'] == "rent") ? "Rent" : "Sale";
