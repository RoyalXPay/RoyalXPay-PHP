...
class UsersModel extends Model
{
    ...
    protected $allowedFields    = ['username','mbme_wallet','otp','first_login_done','otp_expire_time', 'name', 'comapny_website','contactus','logo','company_name','email', 'phone', 'alt_mobile_number', 'password', 'gender', 'otp', 'status', 'address', 'city', 'pincode', 'user_type', 'department', 'designation', 'notes', 'wallet','permissions', 'created_at', 'updated_at'];
    ...
    public function getUsersDetailsold($searchArray = [],$user_type='', $offset = '', $limit = '', $countOnly = '')
    {
        ...
        if ($countOnly) {
            ...
            $builder->select('t.*,  a.city, a.state, a.postal_code, a.country, a.address_type');
        }
