...
use Mpdf\Mpdf;
class Sergas extends BaseController
{
    use ResponseTrait;
    ...
    {
        return view('admin/Api/sergas/index', [
            'pagetitle' => 'Sergas Payment'
        ]);
    }
...
public function receipt($id)
{
    ...
    try {
        $html = view('admin/Api/sergas/receipt_pdf', [
            'txn' => $transaction,
            'merchant' => $merchant,
            'customer' => $customer
        ]);
   ...
   public function reports()
{
    ...
    return view('admin/Api/sergas/report', [
        'transactions' => $transactions,
        'pagetitle' => 'Sergas Payment Reports'
    ]);
}
