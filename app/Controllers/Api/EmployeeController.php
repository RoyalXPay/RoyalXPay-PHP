...
class EmployeeController extends BaseController
{
    ...
    public function getProfileDetails()
    {
        ...
        $company = $this->usersModel->find($employee['user_id']);

        if (!$company) {
            return $this->failNotFound("Merchant not found for this employee.");
        }
    ...
    public function getEmployeeIdCard()
    {
        ...
        $company = $this->usersModel->find($employee['user_id']);
        if (!$company) {
            return $this->failNotFound("Merchant information not found for this employee.");
        }
    ...
    public function getJuniorsEmployees()
    {
        ...
        $juniors = $this->employeeModel
            ->select('
                ...
                users.name,
                users.address AS company_address
            ')
