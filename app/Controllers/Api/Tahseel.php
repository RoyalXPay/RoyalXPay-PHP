...
use Mpdf\Mpdf;
class Tahseel extends BaseController
{
    use ResponseTrait;
    protected $session;
    ...
    {
        return view('admin/Api/tahseel/index', [
            'pagetitle' => 'Tahseel Topup Payment'
        ]);
    }
...
public function receipt($id)
{
    ...
    try {
        $html = view('admin/Api/tahseel/receipt_pdf', [
            'txn' => $transaction,
            'merchant' => $merchant,
            'customer' => $customer
        ]);
    ...
    public function makePayment()
    {
        ...
        try {
            $balanceResponse = $client->post($this->paymentUrl, [
                'headers' => [
            ...
            if (($balanceResult['responseCode'] ?? '') !== '000') {
                return $this->respond([ 'error' => 'Balance fetch failed', 'details' => $balanceResult ]);
            }
            ...
            file_put_contents(WRITEPATH . 'logs/tahseel_payment.log', json_encode($result, JSON_PRETTY_PRINT));
   ...
   public function reports()
{
    ...
    return view('admin/Api/tahseel/report', [
        'transactions' => $transactions,
        'pagetitle' => 'Tahseel Topup Payment Reports'
    ]);
}
