...
use Mpdf\Mpdf;
class Nationalbond extends BaseController
{
    use ResponseTrait;
...
private $hasrequest = 'https://mobportal.mbme.org:11005/mpay/hashRequest';
    ...
    {
        return view('admin/Api/nationalbond/index', [
            'pagetitle' => 'nationalbond Payment'
        ]);
    }
...
public function receipt($id)
{
    ...
    try {
        $html = view('admin/Api/nationalbond/receipt_pdf', [
            'txn' => $transaction,
            'merchant' => $merchant,
            'customer' => $customer
        ]);
 ...
 public function makePayment()
{
 ...
 $numBonds = floor($amountWithoutComm / 10);
    /**
   ...
   public function reports()
    {
        ...
        $builder = $model->where('customer_name', $userId)
                        ->where('Payment_type', 'Nationalbond');
        ...
        return view('admin/Api/nationalbond/report', [
            'transactions' => $transactions,
            'pagetitle' => 'nationalbond Payment Reports'
        ]);
    }
