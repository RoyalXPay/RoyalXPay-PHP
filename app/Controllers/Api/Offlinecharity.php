...
use Mpdf\Mpdf;
class Offlinecharity extends BaseController
{
    use ResponseTrait;
    ...
    {
        return view('admin/Api/offlinecharity/index', [
            'pagetitle' => 'Offlinecharity Payment'
        ]);
    }
...
public function receipt($id)
{
    ...
    try {
        $html = view('admin/Api/offlinecharity/receipt_pdf', [
            'txn' => $transaction,
            'merchant' => $merchant,
            'customer' => $customer
        ]);
   ...
   public function reports()
{
    ...
    $builder = $model->where('customer_name', $userId)
                     ->where('Payment_type', 'Offlinecharity');
    ...
    return view('admin/Api/offlinecharity/report', [
        'transactions' => $transactions,
        'pagetitle' => 'Offlinecharity Payment Reports'
    ]);
}
