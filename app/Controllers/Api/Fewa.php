...
use Mpdf\Mpdf;
class Fewa extends BaseController
{
    use ResponseTrait;
    ...
    {
        return view('admin/Api/fewa/index', [
            'pagetitle' => 'Fewa Payment'
        ]);
    }
...
public function receipt($id)
{
    ...
    try {
        $html = view('admin/Api/fewa/receipt_pdf', [
            'txn' => $transaction,
            'merchant' => $merchant,
            'customer' => $customer
        ]);
   ...
   public function reports()
{
    ...
    return view('admin/Api/fewa/report', [
        'transactions' => $transactions,
        'pagetitle' => 'Fewa Payment Reports'
    ]);
}
