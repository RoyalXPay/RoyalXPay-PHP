...
use Mpdf\Mpdf;
class Dubaided extends BaseController
{
    use ResponseTrait;
    ...
    {
        return view('admin/Api/dubaided/index', [
            'pagetitle' => 'Dubai ded Payment'
        ]);
    }
...
public function receipt($id)
{
    ...
    try {
        $html = view('admin/Api/dubaided/receipt_pdf', [
            'txn' => $transaction,
            'merchant' => $merchant,
            'customer' => $customer
        ]);
      ...
      if (!$token || !$account || !$walletAmount || !$apiPaidAmount || !$name || !$transactionId) {
        ...
        try {
            ...
            $paymentData = [
                ...
                'reqField1'        => $account,
                "reqField2" => "Emirates Id",
                "reqField3" => "784198610249066",
                "reqField4" => "test@gmail.com",
                "reqField5" => "0527679235",
                "reqField6" => "Sreejith",
                "reqField7" => null,
                "reqField8" => null,
                "reqField9" => null,
   ...
   public function reports()
{
    ...
    return view('admin/Api/dubaided/report', [
        'transactions' => $transactions,
        'pagetitle' => 'Dubai ded Payment Reports'
    ]);
}
