...
use Mpdf\Mpdf;
class Dutopup extends BaseController
{
    use ResponseTrait;
...
private $hasrequest = 'https://mobportal.mbme.org:11005/mpay/hashRequest';
    ...
    {
        return view('admin/Api/dutopup/index', [
            'pagetitle' => 'Dutopup Payment'
        ]);
    }
...
public function receipt($id)
{
    ...
    try {
        $html = view('admin/Api/dutopup/receipt_pdf', [
            'txn' => $transaction,
            'merchant' => $merchant,
            'customer' => $customer
        ]);
   ...
   public function reports()
    {
        ...
        return view('admin/Api/dutopup/report', [
            'transactions' => $transactions,
            'pagetitle' => 'Dutopup Payment Reports'
        ]);
    }
