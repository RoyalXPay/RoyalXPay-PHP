            ...
            <div class="container">
                <div class="row d-flex align-items-center justify-content-between pb-5">
                    <div class="col-lg-6 col-sm-12 col-md-12" data-aos="fade-left" data-aos-easing="ease-in-out">
                        ...
                        <h1 class="partner-large-head mt-3">The tower of commerce</h1>
                        <p class="partner-text mt-4 mb-2" style="font-size: 17px;">Welcome to the business engine room of the tower that empowers <br>merchants with tools to accept, manage, and grow.</p>
                        <ol class="bullet-list ps-3" style="list-style-type: disc!important; list-style: disc!important;">
                            <li class="partner-text" style="font-size: 17px;">Accept payments across borders</li>
                            <li class="partner-text" style="font-size: 17px;">Offer prepaid and virtual cards</li>
                            <li class="partner-text" style="font-size: 17px;">Offers Buy Now Pay Later</li> 
                            <li class="partner-text" style="font-size: 17px;">Move money, anytime, anywhere.</li>
                        </ol>
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-12 d-flex justify-content-end align-items-center" data-aos="fade-right" data-aos-easing="ease-in-out">
                        <img src="assets_frontend/images/payment_transparent_hd.png" style="height: auto; width: 100%;" class="banner-img">
                    </div>
                </div>
            </div>
        </section>
