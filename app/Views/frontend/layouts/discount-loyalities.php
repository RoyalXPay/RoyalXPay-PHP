            ...
            <div class="container py-5">
                <div class="row d-flex align-items-center justify-content-between">
                    <div class="col-lg-6 col-sm-12 col-md-12" data-aos="fade-left" data-aos-easing="ease-in-out">
                        ...
                        <h1 class="partner-large-head mt-3" style="font-size: 28px;">The Payment Pillar– Transactions made easy</h1>
                        <h1 class="partner-large-head mt-2">Click. Pay. Done</h1>
                        <p class="partner-text mt-2 mb-2" style="font-size: 17px;">This floor ensures every payment is done in a click– no queues, no confusions.</p>
                        <ol class="bullet-list ps-3" style="list-style-type: disc!important; list-style: disc!important;">
                            <li class="partner-text" style="font-size: 17px;">Savings & fixed deposits </li>
                            <li class="partner-text" style="font-size: 17px;">Instant loans- personal & consumer</li>
                            <li class="partner-text" style="font-size: 17px;">Smooth, real-time invoice and bill settlement</li> 
                            <li class="partner-text" style="font-size: 17px;">Schedule payments</li>
                        </ol>
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-12 d-flex justify-content-end align-items-center" data-aos="fade-right" data-aos-easing="ease-in-out">
                        <img src="assets_frontend/images/discount_transparent_high_quality.png" style="height: auto; width: 100%;" class="banner-img">
                    </div>
                </div>
            </div>
        </section>
