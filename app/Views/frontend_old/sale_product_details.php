            ...
            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12 px-0">
                ...
                <table class="table table-striped price-table table-bordered table-hover price-table-input desktop-view">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <span class="d-flex align-items-center justify-content-center align-self-center text-center">
                                    <?= esc($productDetails->product_price); ?> OMR
                                </span>
                            </td>
                            <td>
                                <span class="d-flex align-items-center justify-content-center align-self-center text-center">
                ...
                <div class="my-4 py-4 description">
                    ...
                    <form class="add-to-cart-form" method="post">
                        ...
                        <input type="hidden" name="price" value="<?= esc($productDetails->product_price) ?>">
                ...
                ?>
                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 mt-5 mb-4 px-4">
                        <div
                            ...
                            style="background-color: #e8e5e5; cursor: pointer;"
                            onclick="window.location.href='<?= site_url('sale/products/details/' . esc($product->product_id, 'url')); ?>'">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4 pt-2">
                            <h5 class="entry-title mkd-pli-title text-center card-title-name m-0">
                                <a href="<?= site_url('sale/products/details/' . esc($product->product_id, 'url')); ?>" class="text-dark text-decoration-none">
                                    <?= esc($product->product_name); ?>
                                </a>
                            </h5>
                            <a href="<?= site_url('sale/products/details/' . esc($product->product_id, 'url')); ?>" class="mkd-pli-new-product">View Details</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php else : ?>
