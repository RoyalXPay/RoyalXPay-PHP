...
<div class="page-content">
    ...
    <div class="d-flex align-items-center">
        <img src="<?= base_url('assets/images/addc_direct.png') ?>" alt="ADDC Logo" style="height:61px; margin-right:10px;">
        <h4 class="card-title m-0">Abu Dhabi Distribution Company (ADDC) Utility Payment</h4>
    </div>
    ...
    switch (type) {
        case 'AccountID':
            if (!/^[0-9]{10}$/.test(value)) {
                errorEl.text('Account number must be exactly 10 digits.').show();
                return false;
            }
            break;
        case 'MobileNo':
    ...
    $('#continueBtn').click(async function () {
        ...
        try {
            ...
            if (payResult.status) {
                ...
                setTimeout(() => { window.location.href = "addc/reports"; }, 2000);
            } else {
