...
<head>
    <meta charset="utf-8" />
    <title>OTP Verification | royalxpay - Secure Access</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Secure OTP verification page for royalxpay">
                    ...
                    <div class="card auth-card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="auth-footer mt-4 text-center">
                                <p class="mb-0">&copy; <?= date('Y') ?> RoyalXPay. All rights reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
