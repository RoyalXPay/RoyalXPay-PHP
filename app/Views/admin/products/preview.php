                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="row">
                                <!-- Product Info: Title, Description, etc. -->
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <p><strong>Discount Percentage:</strong> <?= esc($record['discount_percentage']); ?>%</p>
                                </div>
                                <div class="col-md-4">
                                    <p><strong>Final Product Price:</strong> $<?= esc(number_format($record['final_product_price'], 2)); ?></p>
                                </div>
                                <div class="col-md-4">
