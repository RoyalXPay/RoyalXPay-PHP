    ...
    <div class="container-fluid">
        ...
        <ul class="nav nav-tabs" id="userTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link <?= ($method == 'rentProductReport') ? "active" : "" ?>" href="<?= site_url('reports/rent-product'); ?>" role="tab" aria-controls="Rent" aria-selected="true">Rent</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link" href="<?= site_url('reports/sale-product'); ?>" role="tab" aria-controls="Sale" aria-selected="false">Sale</a>
            </li>
        </ul>
                                            ...
                                            <tbody>
                                                <?php foreach ($results as $items) {
                                                    ...
                                                    if ($items['transaction_type'] == 'quotation') {
                                                        $redirectUrl = "rent-quotations/preview/" . esc($items['quotation_id']);
                                                    } else {
                                                        $redirectUrl = "rent-contracts/preview/" . esc($items['contract_id']);
                                                    }
                                                ?>
                                                    <tr>
                                                        <td><?= ++$startLimit; ?></td>
