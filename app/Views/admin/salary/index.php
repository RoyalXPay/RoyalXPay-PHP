                    ...
                    <div class="page-title-right">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                            <button id="toggleSearchBtn" type="button" class="btn btn-outline-primary waves-effect waves-light">
                             ...
                             <?php if (in_array($user_type, ['superadmin','Superadmin', 'Merchant'])){ ?>
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-sortable="true" class="text-center">Merchant</th>
                                            ...
                                            <tr id="salary-row-<?= $item->salary_id ?>">
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a href="<?= site_url("salary/slip/view/" . $item->salary_id) ?>" class="btn btn-info m-1" data-bs-toggle="tooltip" title="View Salary Slip" target="_blank">
