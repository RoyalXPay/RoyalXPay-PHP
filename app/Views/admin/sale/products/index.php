            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Sale Products List</li>
                    </ol>

                    <div class="page-title-right">
                        <?php if (!empty($permissions) && in_array('add', $permissions)) { ?>
                            <a href="<?= site_url('sale-products/create') ?>" class="btn btn-primary waves-effect waves-light">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4" style="margin-top: 27px;">
                                                ...
                                                <a href="<?= site_url('sale-products'); ?>" class="btn btn-secondary waves-effect waves-light mr-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Clear Searched Filters">
                                ...
                                <table id="datatable" class="table table-bordered table-striped dt-responsive w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-sortable="true" class="text-center">Product Price</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($results as $items) { ?>
                                            <tr>
                                                ...
                                                <td><?= esc($items->product_price); ?></td>
                                                <td><?= esc($items->quantity); ?></td>
                                                <td><?= esc($items->discount_percentage); ?></td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <?php if (!empty($permissions) && in_array('edit', $permissions)) { ?>
                                                            <a href="<?= site_url("sale-products/edit/" . $items->product_id) ?>" class="btn btn-success m-1" data-bs-toggle="tooltip" title="Edit">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        <?php } ?>

                                                        <a href="<?= site_url("sale-products/preview/" . $items->product_id) ?>" class="btn btn-warning m-1" data-bs-toggle="tooltip" title="Preview">
        ...
        $('.dltBtn').click(function(e) {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        type: "GET",
                        url: "<?= site_url('sale-products/delete/') ?>" + dataID,
